...
export class Migration1747132327464 implements MigrationInterface {
    name = 'Migration1747132327464';

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "tasks" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "priority" integer NOT NULL, "due_date" bigint, "status" character varying NOT NULL, "created_at" bigint, "updated_at" bigint, "userIdId" integer, "directoryIdId" integer, CONSTRAINT "CHK_f4d628fb195c5af3467d384e0d" CHECK ("updated_at" >= 0), CONSTRAINT "CHK_fe1b18dd12848e5dbf3d52ca30" CHECK ("created_at" >= 0), CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
